...
This Go application processes receipts and calculates points based on specific rules. The application exposes endpoints to add receipts and retrieve points for a specific receipt.
